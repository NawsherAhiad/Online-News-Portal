...
<html>
    ...
    <?php include "header.php"; ?>
        ...
        <?php
        $sql = "select * from news,image where image.news_news_id=news.news_id and news.headline LIKE '%$keyword%' order by timestamp desc";
        ...
        if(mysqli_num_rows($result) > 0)
                ...
                {
                    ?>
                        <h3>No news found for <?php echo $keyword; ?></h3>
                    <?php
                }
